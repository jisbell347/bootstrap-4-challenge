		...
		<main>
			...
			<div class="container truth pb-4">
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<p>I’ve been following that taco truck around all day. It’s taco time all the time. Does guac cost extra? Fish tacos with cabbage slaw and a side of chips and guac. Tacos, again? This will be 5 times this week and it’s only Tuesday. I think I’ve overdosed on tacos. It’s taco Tuesday Monday. 50 cent tacos! I’ll take 30. TACOS!! I’ve been following that taco truck around all day.</p>
					</div>
				</div>
			</div>
			<hr class="feature-divider">
			<div class="container text-center fact-section">
				...
				<div class="row align-items-baseline">
					...
					<div class="col-lg-3">
						<img src="https://res.cloudinary.com/teepublic/image/private/s--egrv4_ON--/t_Preview/b_rgb:191919,c_limit,f_jpg,h_630,q_90,w_630/v1496551789/production/designs/1644610_1.jpg" alt="Taco Bear Meme" class="rounded-circle pb-2" width="200" height="200">
